...
namespace RetainingWall
{
    internal class Element
    {
        public static List<FemDesign.Shells.Slab> slabs(double MeshSize)
        {
            ...
            Slab SlabBPL = FemDesign.Shells.Slab.FromFourPoints(P1_0, P1_1, P1_2, P1_3, PP1_0[3], materialBtg, EdgeConnection.Default, SlabAlignBottom, null, "BPL");
            Slab SlabMUR = FemDesign.Shells.Slab.FromFourPoints(P2_0, P2_1, P2_2, P2_3, PP2_0[3], materialBtg, EdgeConnection.Default, null, null, "MUR");
            Slab SlabBPLMUR = FemDesign.Shells.Slab.FromFourPoints(P3_0, P3_1, P3_2, P3_3, PP3_0[3], materialBtgNoMass, EdgeConnection.Default, null, null, "BPL-MUR");
