...
namespace RetainingWall
{
    internal class ReinForcement
    {
        public static List<FemDesign.GenericClasses.IStructureElement> straightReinfElements(List<Slab> slabs, string ReinfMaterial)
        {
            ...
            var ExtArm_xB_BPL = new Straight(ReinforcementDirection.X, space_ExtArm_BPL_xB_BPL, FemDesign.GenericClasses.Face.Bottom, cover_bottom_BPL);
            var ExtArm_xT_BPL = new Straight(ReinforcementDirection.X, space_ExtArm_BPL_xT_BPL, FemDesign.GenericClasses.Face.Top, cover_topp_BPL);
            var ExtArm_yB_BPL = new Straight(ReinforcementDirection.Y, space_ExtArm_BPL_yB_BPL, FemDesign.GenericClasses.Face.Bottom, cover_bottom_BPL);
            var ExtArm_yT_BPL = new Straight(ReinforcementDirection.Y, space_ExtArm_BPL_yT_BPL, FemDesign.GenericClasses.Face.Top, cover_topp_BPL);
            ...
            var ExtArm_xB_MUR = new Straight(ReinforcementDirection.X, space_ExtArm_MUR_xB_MUR, FemDesign.GenericClasses.Face.Bottom, cover_bottom_MUR);
            var ExtArm_xT_MUR = new Straight(ReinforcementDirection.X, space_ExtArm_MUR_xT_MUR, FemDesign.GenericClasses.Face.Top, cover_topp_MUR);
            var ExtArm_yB_MUR = new Straight(ReinforcementDirection.Y, space_ExtArm_MUR_yB_MUR, FemDesign.GenericClasses.Face.Bottom, cover_bottom_MUR);
            var ExtArm_yT_MUR = new Straight(ReinforcementDirection.Y, space_ExtArm_MUR_yT_MUR, FemDesign.GenericClasses.Face.Top, cover_topp_MUR);
