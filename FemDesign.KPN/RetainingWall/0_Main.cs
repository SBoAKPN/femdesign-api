...
namespace FemDesign.RetainingWall
{
    internal class Program
    {
        static void Main()
        {
            ...
            //var SlabThicknessBPL = new List<double> { PP1_0[3], PP1_1[3], PP1_2[3] };
            ...
            //var SlabThicknessMur = new List<double> { PP2_0[3], PP2_1[3], PP2_2[3] };
            ...
            //var SlabBPL = FemDesign.Shells.Slab.FromFourPoints(P1_0, P1_1, P1_2, P1_3, PP1_0[3], materialBtg, EdgeConnection.Default, SlabAlignBottom, null, "BPL");
            //var SlabMur = FemDesign.Shells.Slab.FromFourPoints(P2_0, P2_1, P2_2, P2_3, PP2_0[3], materialBtg, EdgeConnection.Default, null, null, "Mur");
            //var SlabBPLMur = FemDesign.Shells.Slab.FromFourPoints(P3_0, P3_1, P3_2, P3_3, PP3_0[3], materialBtgNoMass, EdgeConnection.Default, null, null, "BPL-Mur");
            ...
            //                                     loadCaseEffJHHW, loadCaseEffJMW, loadCaseEffJLLW,loadCaseÖLVU, loadCaseÖLHU, loadCaseÖLVP, loadCaseÖLHP,loadCaseAcc };
            ...
            //var reinfSlab1 = FemDesign.Reinforcement.SurfaceReinforcement.AddReinforcementToSlab(SlabBPL, srfReinf);
            ...
            var BasArm_xB_BPL = new Straight(ReinforcementDirection.X, space_BasArm_BPL_xB_BPL, GenericClasses.Face.Bottom, cover_bottom_BPL);
            var BasArm_xT_BPL = new Straight(ReinforcementDirection.X, space_BasArm_BPL_xT_BPL, GenericClasses.Face.Top, cover_topp_BPL);
            var BasArm_yB_BPL = new Straight(ReinforcementDirection.Y, space_BasArm_BPL_yB_BPL, GenericClasses.Face.Bottom, cover_bottom_BPL);
            var BasArm_yT_BPL = new Straight(ReinforcementDirection.Y, space_BasArm_BPL_yT_BPL, GenericClasses.Face.Top, cover_topp_BPL);

            var ExtraArm_xB_BPL = new Straight(ReinforcementDirection.X, space_ExtraArm_BPL_xB_BPL, GenericClasses.Face.Bottom, cover_bottom_BPL);
            var ExtraArm_xT_BPL = new Straight(ReinforcementDirection.X, space_ExtraArm_BPL_xT_BPL, GenericClasses.Face.Top, cover_topp_BPL);
            var ExtraArm_yB_BPL = new Straight(ReinforcementDirection.Y, space_ExtraArm_BPL_yB_BPL, GenericClasses.Face.Bottom, cover_bottom_BPL);
            var ExtraArm_yT_BPL = new Straight(ReinforcementDirection.Y, space_ExtraArm_BPL_yT_BPL, GenericClasses.Face.Top, cover_topp_BPL);
            ...
            var reinfSlab_BPL = FemDesign.Reinforcement.SurfaceReinforcement.AddReinforcementToSlab(SlabBPL, srfReinf_BPL);
            ...
            {
                new Point3d(PP2_0[0]    ,0   ,3.5),
                new Point3d(PP2_1[0]    ,0   ,PP2_1[2]),
                new Point3d(PP2_2[0]    ,1.0 ,PP2_1[2]),
                new Point3d(PP2_3[0]    ,1.0 ,3.5),
            };
            ...
            var BasArm_xB_Mur = new Straight(ReinforcementDirection.X, space_BasArm_mur_xB_Mur, GenericClasses.Face.Bottom, cover_bottom_mur);
            var BasArm_xT_Mur = new Straight(ReinforcementDirection.X, space_BasArm_mur_xT_Mur, GenericClasses.Face.Top, cover_topp_mur);
            var BasArm_yB_Mur = new Straight(ReinforcementDirection.Y, space_BasArm_mur_yB_Mur, GenericClasses.Face.Bottom, cover_bottom_mur);
            var BasArm_yT_Mur = new Straight(ReinforcementDirection.Y, space_BasArm_mur_yT_Mur, GenericClasses.Face.Top, cover_topp_mur);

            var ExtraArm_xB_Mur = new Straight(ReinforcementDirection.X, space_ExtraArm_mur_xB_Mur, GenericClasses.Face.Bottom, cover_bottom_mur);
            var ExtraArm_xT_Mur = new Straight(ReinforcementDirection.X, space_ExtraArm_mur_xT_Mur, GenericClasses.Face.Top, cover_topp_mur);
            var ExtraArm_yB_Mur = new Straight(ReinforcementDirection.Y, space_ExtraArm_mur_yB_Mur, GenericClasses.Face.Bottom, cover_bottom_mur);
            var ExtraArm_yT_Mur = new Straight(ReinforcementDirection.Y, space_ExtraArm_mur_yT_Mur, GenericClasses.Face.Top, cover_topp_mur);
            ...
            var reinfSlab_Mur = FemDesign.Reinforcement.SurfaceReinforcement.AddReinforcementToSlab(SlabMur, srfReinf_Mur);

            var elements = new List<FemDesign.GenericClasses.IStructureElement> { reinfSlab_BPL, reinfSlab_Mur, SlabBPLMur, SurfaceSupport1 };
            ...
            var LabelledSections = new FemDesign.AuxiliaryResults.LabelledSection(LabelledS_Points, "LS");
